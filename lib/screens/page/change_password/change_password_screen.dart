...
class _ChangePasswordScreenState extends State<ChangePasswordScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PageAppbar(firstTitle: "Change", secondTitle: "Password"), //TODO:
  ...
  Widget _buildForm(BuildContext context) {
    var model = Provider.of<ChangePassword>(context, listen: true);
    return Form(
      key: _formKey,
  ...
  Future<void> _onChangePasswordPressed() async {
    ...
    await showLoading();
    try {
      model = Provider.of<ChangePassword>(context, listen: false);
