...
class NewsBullet {
  ...
  NewsBullet.fromJSONMap(Map<String, dynamic> jsonMap) {
    ...
    this.description = jsonMap["content"];
    this.createdAt = DateTime.parse(jsonMap["dateISO"]).toLocal();
  }
}
...
class NewsState extends ChangeNotifier {
  ...
  Future<void> fetchNews() async {
    NewsBulletResponse response = await newsApi.fetchNewsBullets(
  ...
  Future<void> fetchNewsAtPage(int page) async {
    ...
    // _currentPage = page;
    // notifyListeners();
    print("fetchNewsAtPage: " + _currentPage.toString()); //TODO
