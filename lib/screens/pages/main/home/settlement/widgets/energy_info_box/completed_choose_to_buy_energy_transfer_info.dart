...
class CompletedChooseToBuyEnergyTransferInfoBox extends StatelessWidget {
  final CompletedChooseToBuyEnergyTransferInfo tradeInfo;
  final bool defaultExpanded;

  const CompletedChooseToBuyEnergyTransferInfoBox({
    Key? key,
