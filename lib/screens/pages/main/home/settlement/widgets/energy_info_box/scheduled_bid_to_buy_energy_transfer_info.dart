...
class ScheduledBidToBuyEnergyTransferInfoBox extends StatelessWidget {
  final ScheduledBidToBuyEnergyTransferInfo tradeInfo;
  final bool defaultExpanded;

  const ScheduledBidToBuyEnergyTransferInfoBox({
    Key? key,
    ...
    return DatedEnergyDetail(
      ...
      items: [
        DatedEnergyDetailBoxItem(
          name: AppLocalizations.of(context).translate('settlement-bidedAmount-matched'),
