...
class PoolSellerEnergyShortfallSettlementReportInfoBox extends StatelessWidget {
  final PoolSellerEnergyShortfallSettlementReportInfo tradeInfo;
  final bool defaultExpanded;

  const PoolSellerEnergyShortfallSettlementReportInfoBox({
    Key? key,
