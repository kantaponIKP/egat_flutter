...
class PoolBuyerEnergyShortfallSettlementReportInfoBox extends StatelessWidget {
  final PoolBuyerEnergyShortfallSettlementReportInfo tradeInfo;
  final bool defaultExpanded;

  const PoolBuyerEnergyShortfallSettlementReportInfoBox({
    Key? key,
