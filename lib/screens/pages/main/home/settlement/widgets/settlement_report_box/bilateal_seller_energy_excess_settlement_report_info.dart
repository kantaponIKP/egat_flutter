...
class BilateralSellerEnergyExcessSettlementReportInfoBox
    extends StatelessWidget {
  final BilateralSellerEnergyExcessSettlementReportInfo tradeInfo;
  final bool defaultExpanded;

  const BilateralSellerEnergyExcessSettlementReportInfoBox({
    Key? key,
    ...
    return DatedSettlementReportDetail(
      ...
      items: [
        ...
        DatedSettlementReportDetailBoxItem(
          ...
          value: '${tradeInfo.netSales.toStringAsFixed(3)} THB/kWh',
          fontSize: 10,
        ),
      ],
    );
